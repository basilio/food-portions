		...
		subgroups: [
			{
				...
				food_types: [
					{
						name: 'Arroz, arroz integral, fideos, fideos integrales, choclo, porotos granados',
						values: [
							{
								unit: 'taza',
								value: '3/4'
		...
		subgroups: [
			{
				...
				food_types: [
					{
						name: 'Azúcar, miel de abeja, miel de palma, mermeladas, dulce de membrillo, manjar, jalea y jugo en polvo',
						values: [
							{
								unit: 'cdta',
								value: 1
